...
- 🎯 Entry points to execute your program using `python -m <kwiziz>` or `$ kwiziz` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/ncthuc/kwiziz/branch/main/graph/badge.svg?token=kwiziz_token_here)](https://codecov.io/gh/ncthuc/kwiziz)
[![CI](https://github.com/ncthuc/kwiziz/actions/workflows/main.yml/badge.svg)](https://github.com/ncthuc/kwiziz/actions/workflows/main.yml)

Awesome kwiziz created by ncthuc

## Install

from source
```bash
git clone https://github.com/ncthuc/kwiziz kwiziz
cd kwiziz
make install
```
...
```bash
$ kwiziz run --port 8080
```

or

```bash
python -m kwiziz run --port 8080
```
...
```bash
❯ kwiziz --help
Usage: kwiziz [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ kwiziz create-user --help
Usage: kwiziz create-user [OPTIONS] USERNAME PASSWORD
...
```bash
kwiziz create-user admin admin --superuser
```
...
Run with `kwiziz run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `kwiziz create-user`.
...
-----------------------------------------------------
kwiziz/__init__.py              4      0   100%
kwiziz/app.py                  16      1    94%
kwiziz/cli.py                  21      0   100%
kwiziz/config.py                5      0   100%
kwiziz/db.py                   10      0   100%
kwiziz/models/__init__.py       0      0   100%
kwiziz/models/content.py       47      1    98%
kwiziz/routes/__init__.py      11      0   100%
kwiziz/routes/content.py       52     25    52%
kwiziz/routes/security.py      15      1    93%
kwiziz/routes/user.py          52     26    50%
kwiziz/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in kwiziz/default.toml.
